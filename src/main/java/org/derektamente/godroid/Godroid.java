package org.derektamente.godroid;
...
public class Godroid extends GodotPlugin {
    private static final String TAG = "godot";
    private final Activity activity;

    public Godroid(Godot godot) {
        super(godot);
    ...
    {
        activity.runOnUiThread(() -> Toast.makeText(activity, mess, Toast.LENGTH_LONG).show());
    }
